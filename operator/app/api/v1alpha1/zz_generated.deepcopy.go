...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SlideSpec) DeepCopyInto(out *SlideSpec) {
	*out = *in
	if in.Bullets != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SlideSpec.
func (in *SlideSpec) DeepCopy() *SlideSpec {
	if in == nil {
		return nil
	}
	out := new(SlideSpec)
